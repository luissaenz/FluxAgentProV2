...
class AgentFactory:
    ...
    def create_agent(config: Dict[str, Any], org_id: str) -> Agent:
        ...
        for tool_name in allowed_tools:
            try:
                ...
                logger.warning("Tool '%s' not found in registry for agent creation", tool_name)
    ...
    @staticmethod
    def create_task(description: str, agent: Agent, expected_output: str = "Structured result") -> Task:
